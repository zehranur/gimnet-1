namespace Gimnet.Sertifika
{
    ...
    {
        [InlineConstant] public const string BaseUrl = "Sertifika/HelalSertifika";
        ...
        {
            [InlineConstant] public const string Create = "Sertifika/HelalSertifika/Create";
            [InlineConstant] public const string Update = "Sertifika/HelalSertifika/Update";
            [InlineConstant] public const string Delete = "Sertifika/HelalSertifika/Delete";
            [InlineConstant] public const string Retrieve = "Sertifika/HelalSertifika/Retrieve";
            [InlineConstant] public const string List = "Sertifika/HelalSertifika/List";
        }
    }

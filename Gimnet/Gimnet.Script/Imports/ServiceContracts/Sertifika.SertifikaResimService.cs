namespace Gimnet.Sertifika
{
    ...
    {
        [InlineConstant] public const string BaseUrl = "Sertifika/SertifikaResim";
        ...
        {
            [InlineConstant] public const string Create = "Sertifika/SertifikaResim/Create";
            [InlineConstant] public const string Update = "Sertifika/SertifikaResim/Update";
            [InlineConstant] public const string Delete = "Sertifika/SertifikaResim/Delete";
            [InlineConstant] public const string Retrieve = "Sertifika/SertifikaResim/Retrieve";
            [InlineConstant] public const string List = "Sertifika/SertifikaResim/List";
        }
    }
